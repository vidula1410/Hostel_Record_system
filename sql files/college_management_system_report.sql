...
CREATE TABLE `report` (
  ...
  CONSTRAINT `report_ibfk_1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`Faculty_ID`),
  CONSTRAINT `report_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `student` (`Student_ID`)
