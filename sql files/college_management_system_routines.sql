...
--
-- Dumping events for database 'college_management_system'
--

--
-- Dumping routines for database 'college_management_system'
--
/*!50003 DROP FUNCTION IF EXISTS `getEnrollmentCount` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `getEnrollmentCount`(studentID INT) RETURNS int
    DETERMINISTIC
BEGIN
...
-- Dump completed on 2023-11-24 11:16:08
